...
//	    	mc.fontRenderer.drawString(text,xPos+180/2-mc.fontRenderer.getStringWidth(text)/2,yy+20/2-mc.fontRenderer.FONT_HEIGHT/2,0xFFFF00);
	    	...
	    	float speedometerAngle = 18 * context.getSpeed();
//	    	float speedometerAngle = 18 * (GuiStats.tick%20);
	    	
	    	float gauge_01_percentile = (GuiStats.tick%20)/20f;
	    	float gauge_02_percentile = (GuiStats.tick%20)/20f;
