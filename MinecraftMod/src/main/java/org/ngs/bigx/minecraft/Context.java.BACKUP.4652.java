<<<<<<< Updated upstream:MinecraftMod/src/main/java/org/ngs/bigx/minecraft/Context.java
...
public class Context {
	...
	public void setSpeed(float speed) {
		float f = 1000;
		speed = ((float) Math.round(speed*f))/f;
		this.speed = speed;
...
>>>>>>> Stashed changes:MinecraftMod/src/main/java/com/ramon/hellow/Context.java
