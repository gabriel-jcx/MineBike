...
public class QuestTaskChasingFire extends QuestTask implements IQuestEventAttack, IQuestEventItemUse {
	...
	public QuestTaskChasingFire(LevelSystem levelSys, QuestManager questManager, EntityPlayer p, WorldServer worldServer, int level, int maxLevel, QuestChaseTypeEnum questChaseType) {
	...
	public QuestTaskChasingFire(LevelSystem levelSys, QuestManager questManager, EntityPlayer p, WorldServer worldServer, int level, int maxLevel) {
...
//			Minecraft.getMinecraft().gameSettings.mouseSensitivity = 0;
	...
	public String getTaskName() {
		return QuestTaskChasingFire.class.toString();
	}
