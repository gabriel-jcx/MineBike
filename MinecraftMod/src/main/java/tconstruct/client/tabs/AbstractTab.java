...
public abstract class AbstractTab extends GuiButton {
   ...
   public void drawButton(Minecraft mc, int mouseX, int mouseY) {
      if(super.visible) {
         ...
         GL11.glEnable(2896);
         GL11.glEnable('\u803a');
         this.itemRenderer.renderItemAndEffectIntoGUI(mc.fontRenderer, mc.renderEngine, this.renderStack, super.xPosition + 6, super.yPosition + 8);
         this.itemRenderer.renderItemOverlayIntoGUI(mc.fontRenderer, mc.renderEngine, this.renderStack, super.xPosition + 6, super.yPosition + 8);
         GL11.glDisable(2896);
         GL11.glEnable(3042);
