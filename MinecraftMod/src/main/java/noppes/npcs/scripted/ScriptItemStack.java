...
public class ScriptItemStack {
   ...
   public Object getTag(String key) {
      ...
      return tag == null?null:(tag instanceof NBTPrimitive?Double.valueOf(((NBTPrimitive)tag).func_150286_g()):(tag instanceof NBTTagString?((NBTTagString)tag).func_150285_a_():tag));
   }
