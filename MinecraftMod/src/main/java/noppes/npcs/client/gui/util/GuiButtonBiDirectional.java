...
public class GuiButtonBiDirectional extends GuiNpcButton {
   ...
   public void drawButton(Minecraft mc, int mouseX, int mouseY) {
      if(super.visible) {
         ...
         if((float)mc.fontRenderer.getStringWidth(super.displayString) > maxWidth) {
         ...
         this.drawCenteredString(mc.fontRenderer, text, super.xPosition + super.width / 2, super.yPosition + (super.height - 8) / 2, l);
      }
   }
