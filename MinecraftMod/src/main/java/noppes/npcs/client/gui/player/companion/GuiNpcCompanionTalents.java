...
public class GuiNpcCompanionTalents extends GuiNPCInterface {
   ...
   public void drawScreen(int i, int j, float f) {
      ...
      super.mc.fontRenderer.drawString(s1, super.guiLeft + super.xSize / 2 - super.mc.fontRenderer.getStringWidth(s1) / 2, super.guiTop + 10, CustomNpcResourceListener.DefaultTextColor);
   ...
   public static class GuiTalent extends GuiScreen {
      ...
      public void drawScreen(int i, int j, float f) {
         ...
         GuiScreen.itemRender.renderItemAndEffectIntoGUI(mc.fontRenderer, mc.getTextureManager(), item, this.x + 4, this.y + 4);
         GuiScreen.itemRender.renderItemOverlayIntoGUI(mc.fontRenderer, mc.getTextureManager(), item, this.x + 4, this.y + 4);
