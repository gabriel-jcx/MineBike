...
public class GuiMenuSideButton extends GuiNpcButton {
   ...
   public void drawButton(Minecraft minecraft, int i, int j) {
      if(super.visible) {
         ...
         super.field_146123_n = i >= super.xPosition && j >= super.yPosition && i < super.xPosition + width && j < super.yPosition + super.height;
   ...
   public boolean mousePressed(Minecraft minecraft, int i, int j) {
      return !this.active && super.visible && super.field_146123_n;
   }
