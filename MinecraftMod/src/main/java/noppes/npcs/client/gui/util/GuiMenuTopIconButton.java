   ...
   public void drawButton(Minecraft minecraft, int i, int j) {
      if(this.getVisible()) {
         ...
         if(super.hover && !super.active) {
            int x = i + mc.fontRenderer.getStringWidth(super.displayString);
            GL11.glTranslatef((float)x, (float)(super.yPosition + 2), 0.0F);
            this.drawHoveringText(Arrays.asList(new String[]{super.displayString}), 0, 0, mc.fontRenderer);
            GL11.glTranslatef((float)(-x), (float)(-(super.yPosition + 2)), 0.0F);
         }
         ...
         itemRender.renderItemAndEffectIntoGUI(mc.fontRenderer, mc.getTextureManager(), this.item, super.xPosition + 6, super.yPosition + 10);
         itemRender.renderItemOverlayIntoGUI(mc.fontRenderer, mc.getTextureManager(), this.item, super.xPosition + 6, super.yPosition + 10);
