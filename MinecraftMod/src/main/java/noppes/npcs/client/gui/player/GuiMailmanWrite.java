...
public class GuiMailmanWrite extends GuiContainerNPCInterface implements ITextfieldListener, IGuiError, IGuiClose, GuiYesNoCallback {
   ...
   private void func_74160_b(String par1Str) {
      ...
      int i = this.mc.fontRenderer.splitStringWidth(s2 + "" + EnumChatFormatting.BLACK + "_", 118);
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      this.mc.fontRenderer.drawString(s, super.field_147003_i - l + this.bookImageWidth - 44, super.field_147009_r + 18, 0);
      this.mc.fontRenderer.drawSplitString(s1, super.field_147003_i + 36, super.field_147009_r + 18 + 16, 116, 0);
