...
public class CustomItems {
   ...
   public static void load() {
      ...
      redstoneBlock = (new BlockNpcRedstone()).setHardness(50.0F).setResistance(2000.0F).setBlockName("npcRedstoneBlock").setBlockTextureName("customnpcs:npcRedstoneBlock").setCreativeTab(tab);
      ...
      if(!CustomNpcs.DisableExtraBlock) {
         ...
         Block bronze = (new BlockPlaceholder()).setBlockName("npcPlaceholder").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabMisc);
