...
public class ItemStaff extends ItemNpcInterface implements IProjectileCallback {
   ...
   public ItemStack getProjectile(ItemStack stack) {
      return stack.getItem() == CustomItems.staffWood ? new ItemStack(CustomItems.spellNature):
    	  	(stack.getItem() != CustomItems.staffStone && stack.getItem() != CustomItems.staffDemonic?
    	  		(stack.getItem() == CustomItems.staffIron ? new ItemStack(CustomItems.spellHoly):
	    	  	(stack.getItem() == CustomItems.staffBronze ? new ItemStack(CustomItems.spellLightning):
	    	  	(stack.getItem() == CustomItems.staffGold ? new ItemStack(CustomItems.spellFire):
	    	  	(stack.getItem() != CustomItems.staffDiamond && stack.getItem() != CustomItems.staffFrost?
	    	  		(stack.getItem() == CustomItems.staffEmerald ? new ItemStack(CustomItems.spellArcane):
		    	  		new ItemStack(CustomItems.orb, 1, stack.getItemDamage())):
		    	  	new ItemStack(CustomItems.spellIce))))):
		    	new ItemStack(CustomItems.spellDark));
   }
