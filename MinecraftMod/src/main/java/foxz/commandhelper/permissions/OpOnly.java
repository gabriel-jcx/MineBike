...
public class OpOnly extends AbstractPermission {
   ...
   public boolean delegate(AbstractCommandHelper parent, String[] args) {
      return !(parent.pcParam instanceof EntityPlayer)?true:MinecraftServer.getServer().getConfigurationManager().func_152596_g(((EntityPlayer)parent.pcParam).getGameProfile());
   }
}
