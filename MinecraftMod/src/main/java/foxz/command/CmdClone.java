...
public class CmdClone extends ChMcLogger {
   ...
   public boolean spawn(String[] args) {
      ...
      if(compound == null) {
         ...
         double posX = (double)super.pcParam.getPlayerCoordinates().posX;
         double posY = (double)super.pcParam.getPlayerCoordinates().posY;
         double posZ = (double)super.pcParam.getPlayerCoordinates().posZ;
         if(args.length > 2) {
            ...
            if(entity.contains(",")) {
               ...
               try {
                  posX = CommandBase.func_110666_a(super.pcParam, posX, npc[0]);
                  posY = CommandBase.func_110665_a(super.pcParam, posY, npc[1].trim(), 0, 0);
                  posZ = CommandBase.func_110666_a(super.pcParam, posZ, npc[2]);
